...
def input_ftsuoe(n, posdata, frameno, timestep, last_velocities,
    ...
    if n < 0:
        ...
        if n == 12:
            ...
            (Ea_in, U_infinity, O_infinity, centre_of_background_flow,
             Ot_infinity, Et_infinity) = constant_shear(
                gammadot=0.00796, frameno=frameno, timestep=timestep,
                num_spheres=num_spheres)
            desc="shear0.00796"
        elif n == 13:
            # Constant shear
            (Ea_in, U_infinity, O_infinity, centre_of_background_flow,
             Ot_infinity, Et_infinity) = constant_shear(
                gammadot=0.0925, frameno=frameno, timestep=timestep,
                num_spheres=num_spheres)
            desc="shear0.0925"
            ...
            (Ea_in, U_infinity, O_infinity, centre_of_background_flow,
             Ot_infinity, Et_infinity) = constant_shear(
                gammadot=0.0842, frameno=frameno, timestep=timestep,
                num_spheres=num_spheres)
            desc="shear0.0842"
        elif n == 15:
            # Constant shear
            (Ea_in, U_infinity, O_infinity, centre_of_background_flow,
             Ot_infinity, Et_infinity) = constant_shear(
                gammadot=0.0351, frameno=frameno, timestep=timestep,
                num_spheres=num_spheres)
            desc="shear0.0351"
        elif n == 16:
            # Constant shear
            (Ea_in, U_infinity, O_infinity, centre_of_background_flow,
             Ot_infinity, Et_infinity) = constant_shear(
                gammadot=0.037, frameno=frameno, timestep=timestep,
                num_spheres=num_spheres)
            desc="shear0.037"
        elif n == 17:
            # Constant shear
            (Ea_in, U_infinity, O_infinity, centre_of_background_flow,
             Ot_infinity, Et_infinity) = constant_shear(
                gammadot=0.039, frameno=frameno, timestep=timestep,
                num_spheres=num_spheres)
            desc="shear0.039"
        elif n == 18:
            # Constant shear
            ...
            (Ea_in, U_infinity, O_infinity, centre_of_background_flow,
             Ot_infinity, Et_infinity) = constant_shear(
                gammadot=0.023, frameno=frameno, timestep=timestep,
                num_spheres=num_spheres)
            desc="shear0.023"
        elif n ==25:
            # Constant shear
            (Ea_in, U_infinity, O_infinity, centre_of_background_flow,
             Ot_infinity, Et_infinity) = constant_shear(
                gammadot=0.08, frameno=frameno, timestep=timestep,
                num_spheres=num_spheres)
            desc="shear0.08"
        elif n ==26:
            # Constant shear
            (Ea_in, U_infinity, O_infinity, centre_of_background_flow,
             Ot_infinity, Et_infinity) = constant_shear(
                gammadot=0.098, frameno=frameno, timestep=timestep,
                num_spheres=num_spheres)
            desc="shear0.098"
        elif n ==27:
            # Constant shear
            (Ea_in, U_infinity, O_infinity, centre_of_background_flow,
             Ot_infinity, Et_infinity) = constant_shear(
                gammadot=0.0268, frameno=frameno, timestep=timestep,
                num_spheres=num_spheres)
            desc="shear0.0268"
        elif n ==28:
            # Constant shear
            (Ea_in, U_infinity, O_infinity, centre_of_background_flow,
             Ot_infinity, Et_infinity) = constant_shear(
                gammadot=0.0348, frameno=frameno, timestep=timestep,
                num_spheres=num_spheres)
            desc="shear0.0348"
        elif n ==29:
            # Constant shear
            (Ea_in, U_infinity, O_infinity, centre_of_background_flow,
             Ot_infinity, Et_infinity) = constant_shear(
                gammadot=0.0261, frameno=frameno, timestep=timestep,
                num_spheres=num_spheres)
            desc="shear0.0261"
        elif n ==30:
            # Constant shear
